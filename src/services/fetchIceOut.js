...
const ICEOUT_URL = "https://iceout.org/api/reports/";
...
export async function fetchIceOutData() {
  ...
  const res = await request(`${ICEOUT_URL}?${params.toString()}`, {
    method: "GET",
    headers: {
      "X-API-Version": "1.4",
      Accept: "application/msgpack",
      Referer: "https://iceout.org/",
  ...
  if (res.statusCode < 200 || res.statusCode >= 300) {
    ...
    throw new Error(`IceOut HTTP ${res.statusCode}: ${snippet}`);
  }
